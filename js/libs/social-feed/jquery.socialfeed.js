                        ...
                        if (element.id) {
                            ...
                            if (options.show_media === true) {
                                if (element.entities.media && element.entities.media.length > 0) {
                                    ...
                                    if (image_url) {
                                        post.attachment = '<img class="attachment feed_img twitterImgSize" src="' + image_url + '" />';
                                    }
                                }
                            }
                        }
            ...
            facebook: {
                ...
                utility: {
                    ...
                    prepareAttachment: function(element) {
                        ...
                        return '<img class="attachment feed_img" src="' + image_url + '" />';
                    },
                ...
                utility: {
                    ...
                    unifyPostData: function(element) {
                        ...
                        if (options.show_media) {
                            post.attachment = '<img class="attachment feed_img" src="' + element.images.standard_resolution.url + '' + '" />';
                        }
                        return post;
                    }
                }
